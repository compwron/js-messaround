...
gulp.task('javascript', ['clean:public'], function() {
...
gulp.task('vendor-js', ['javascript'], function() {
...
gulp.task('vendor-bootstrap', ['vendor-js'], function() {
  return gulp.src(['bower_components/bootstrap/dist/**/*.*'], { base: './bower_components' })
    .pipe(gulp.dest('public'));
});

gulp.task('css', ['vendor-bootstrap'], function() {
...
gulp.task('setup', ['javascript', 'vendor-js', 'vendor-bootstrap', 'css'], function() {

});

gulp.task('mocha', ['setup'], () => {
...
gulp.task('lint', function () {
    ...
    return gulp.src(['**/*.js','!node_modules/**', '!public/bootstrap/**', '!public/javascript/lib/**', '!dest/**'])
        .pipe(eslint())
        .pipe(eslint.format());
        // .pipe(eslint.failAfterError()); # TODO gotta fix those errors
});
